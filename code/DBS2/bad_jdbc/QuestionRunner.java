...
abstract class QuestionRunner {
	...
	Connection conn;
	private static String fileName = "C:\\Users\\kenneth\\Desktop\\results119.xls";
	...
	private void report(int[] before, int[] after, long startTime, long endTime) {
		...
		try {
			excelHandler.addLabel(0, rowCount, String.valueOf(endTime - startTime));
			excelHandler.addLabel(1, rowCount, String.valueOf(after[consistentGets] - before[consistentGets]));
			excelHandler.finish();
			rowCount++;
